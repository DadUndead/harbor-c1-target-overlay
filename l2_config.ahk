...
NPC_CUSTOM_FILE := A_ScriptDir "\npc_custom.txt"   ; names of server-added/repurposed mobs with no stat/drop data - just tagged "[custom]" on the panel
...
g_npc_custom := Map()  ; lowercase npc name -> true, for server-added/repurposed mobs with no stat/drop data
